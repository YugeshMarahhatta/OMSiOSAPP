...
class SideMenuViewController: UIViewController {
    ...
    var menu: [SideMenuModel] = [
        SideMenuModel(icon: UIImage(systemName: "rectangle.3.group.fill")!, title: "Dashboard"),
        SideMenuModel(icon: UIImage(systemName: "doc.fill.badge.plus")!, title: "Leave Details"),
        SideMenuModel(icon: UIImage(systemName: "note.text")!, title: "Apply Leave"),
